...
PreviewPanel::PreviewPanel(wxWindow* parent)
  ...
  canvas = new wxGLCanvas(this, wxID_ANY, attribList, wxDefaultPosition,
                          wxSize(100, 100));
