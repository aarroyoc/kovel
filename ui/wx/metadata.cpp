...
MetadataDialog::MetadataDialog(wxWindow* parent,bool newFile) : wxDialog(parent,wxID_ANY,"Metadata")
{
	...
	name->Add(nameLabel);
	this->name=core->name;
	wxTextCtrl* nameForm=new wxTextCtrl(this,wxID_ANY, (newFile) ? "" : wxString::FromUTF8(this->name.c_str()));
	...
	wxTextCtrl* authorForm=new wxTextCtrl(this,wxID_ANY,(newFile) ? "" : wxString::FromUTF8(this->author.c_str()));
